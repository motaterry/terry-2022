...
## 🤖 Using Context7 with Cursor AI

This project is integrated with [Context7](https://context7.com/) to improve code generation quality in Cursor AI by providing version-specific documentation.

### Quick Start

Add `use context7` to your Cursor prompts with the exact library versions:
...
```
use context7 for react@19.2.0, next@16.0.1, tailwindcss@4, class-variance-authority@0.7.1
...
For complete usage guide, see [`CONTEXT7_USAGE.md`](./CONTEXT7_USAGE.md).

**Key Points:**
- Context7 doesn't require installing packages
- Use exact versions matching `package.json`
- Always verify generated code follows design system patterns
...
- [Context7 Usage Guide](./CONTEXT7_USAGE.md)
